...
var createResource = exports.createResource = function createResource(resource, config) {
  return function (dispatch, getState) {
    dispatch(apiWillCreate(resource));

    var _ref = config || getState().api.endpoint,
...
var updateResource = exports.updateResource = function updateResource(resource, config) {
  return function (dispatch, getState) {
    dispatch(apiWillUpdate(resource));

    var _ref3 = config || getState().api.endpoint,
        axiosConfig = _ref3.axiosConfig;
...
var deleteResource = exports.deleteResource = function deleteResource(resource, config) {
  return function (dispatch, getState) {
    dispatch(apiWillDelete(resource));

    var _ref4 = config || getState().api.endpoint,
        axiosConfig = _ref4.axiosConfig;
...
// Reducers
var reducer = exports.reducer = (0, _reduxActions.handleActions)((_handleActions = {}, (0, _defineProperty3.default)(_handleActions, _constants.API_SET_AXIOS_CONFIG, function (state, _ref5) {
  var axiosConfig = _ref5.payload;

  return (0, _objectPathImmutable2.default)(state).set(['endpoint', 'axiosConfig'], axiosConfig).value();
}), (0, _defineProperty3.default)(_handleActions, _constants.API_HYDRATE, function (state, _ref6) {
  var resources = _ref6.payload;
...
}), (0, _defineProperty3.default)(_handleActions, _constants.API_CREATED, function (state, _ref7) {
...
}), (0, _defineProperty3.default)(_handleActions, _constants.API_READ, function (state, _ref8) {
  ...
  return (0, _objectPathImmutable2.default)(state).set(['isReading'], state.isReading - 1).value();
}), (0, _defineProperty3.default)(_handleActions, _constants.API_WILL_UPDATE, function (state, _ref9) {
...
}), (0, _defineProperty3.default)(_handleActions, _constants.API_UPDATED, function (state, _ref10) {
  var resources = _ref10.payload;
...
}), (0, _defineProperty3.default)(_handleActions, _constants.API_UPDATE_FAILED, function (state, _ref11) {
...
}), (0, _defineProperty3.default)(_handleActions, _constants.API_WILL_DELETE, function (state, _ref12) {
  var resource = _ref12.payload;
  var type = resource.type,
      id = resource.id;
...
}), (0, _defineProperty3.default)(_handleActions, _constants.API_DELETED, function (state, _ref13) {
  var resource = _ref13.payload;

  return (0, _stateMutation.removeResourceFromState)(state, resource).set('isDeleting', state.isDeleting - 1).value();
}), (0, _defineProperty3.default)(_handleActions, _constants.API_DELETE_FAILED, function (state, _ref14) {
  var resource = _ref14.payload.resource;
  var type = resource.type,
      id = resource.id;
